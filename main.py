...
GUI:
    ...
    Make SN selection a drop down, this will show user what probes currently have calibration data
'''
...
# def parse_cal(pack, c_info):
# # parse_cal uses (eventually) user input to populate the calibration data
# # this is not my best work. Maybe redo?
# # This should be overwritten by dropdowns
#
#     #test values
#     psens1 = 13
#     psens2 = 19
...
#     serials = []
#
#     for sn in [psens1, psens2]:
#
#         serials.append(p_sensor)
#
#     serials.append(str(tsens).rjust(4,'0'))
#
#
#
#
